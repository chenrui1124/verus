...
<template>
  <button
    ...
    :class="[
      'group/v-button relative flex h-9 cursor-pointer items-center justify-center gap-2 rounded-v1 border-none px-4 text-sm tracking-wider transition duration-300 before:v-shade before:transition before:duration-300 focus-visible:v-outline data-[danger]:focus-visible:v-outline-danger',
      {
