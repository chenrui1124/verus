...
<template>
  <component
    ...
    :class="[
      ...
      cm({
        'bg-pri text-on-pri before:border-1.2 before:border-solid before:border-white/16 before:border-b-black/16 hover:before:bg-bsc/8 focus:text-on-pri/72 focus:before:border-transparent focus:before:bg-on-bsc/12':
          'solid',
        'bg-pri-var text-on-pri-var hover:before:bg-on-bsc/8 focus:before:bg-on-bsc/12': 'tonal',
        'before:border-1.2 before:border-solid before:border-otl focus:before:border-current':
          'outlined',
        'bg-transparent text-pri hover:before:bg-pri/8 focus:before:bg-pri/12': [
          'outlined',
          'clean'
        ],
