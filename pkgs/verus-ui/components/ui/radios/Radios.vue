  ...
  <div :style="{ width }" class="flex flex-col gap-2">
    ...
    >
      ...
      <input
        ...
        :value="item.value"
        v-model="modelValue"
        class="pointer-events-none m-0 ml-auto box-border size-4 appearance-none rounded-full border-v1 border-solid border-inherit bg-bsc outline-none transition-all duration-inherit checked:border-4 group-active/v-radio:scale-75"
      />
    </label>
  </div>
</template>
